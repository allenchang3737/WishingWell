//
//  WishProductViewController.swift
//  WishingWell
//
...
class WishProductViewController: UIViewController {
    ...
    var search: Search {
        get {
            return AppManager.shared.wishSearch
        }
        set {
            AppManager.shared.wishSearch = newValue
        }
    }
    ...
    func setupLayout() {
        ...
        let tap = UITapGestureRecognizer(target: self, action: #selector(newWishAction))
...
extension WishProductViewController: UISearchBarDelegate {
...
extension WishProductViewController: UICollectionViewDataSource, UICollectionViewDelegate, UICollectionViewDelegateFlowLayout {
...
//MARK: Server
extension WishProductViewController {
    func searchProducts() {
